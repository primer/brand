...
- Added new functional design tokens: `--brand-color-text-emphasized`, `--brand-color-text-link`, `--brand-color-text-error`, `--brand-color-canvas-muted`
...
- Updated `--brand-InlineLink-color-rest` and `--brand-Link-color-accent` to reference the new `--brand-color-text-link` functional token
