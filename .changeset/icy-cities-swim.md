...
Updates to the `SubNav` component:

- Visual overhaul of active states, typography, and narrow viewport menu toggle
- Top and bottom borders now included by default on the container. This may cause double borders if the surrounding layout already apply borders
