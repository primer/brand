...
+ --brand-text-letterSpacing-350: 0.01em;
```
      
```diff
- --brand-text-letterSpacing-300: 0em;
+ --brand-text-letterSpacing-300: 0.01em;
```
      
```diff
- --brand-text-letterSpacing-200: 0em;
+ --brand-text-letterSpacing-200: 0.01em;
```
      
```diff
- --brand-text-letterSpacing-100: 0.02em;
+ --brand-text-letterSpacing-100: 0.01em;
```
...
```diff
+ --brand-text-subhead-letterSpacing-large: 0.01em;
```
      
```diff
+ --brand-text-subhead-letterSpacing-medium: 0.01em;
```
