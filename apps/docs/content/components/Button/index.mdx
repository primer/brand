...
Accent buttons share a similar hierarchical priority, and should also be used sparingly to avoid diluting its effectiveness. Crucially, accent buttons should only be used in the [hero](../../Hero) and [CTA banner](../../CTABanner) components.
