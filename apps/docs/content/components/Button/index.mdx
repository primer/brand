...
<img src={header} alt="An image showing different button types" />
...
Accent buttons share a similar hierarchical priority, and should also be used sparingly to avoid diluting their effectiveness. Crucially, accent buttons should only be used in the [hero](../../Hero) and [CTA banner](../../CTABanner) components.

<img src={buttonAccent} alt="An image showing all accent states." />
