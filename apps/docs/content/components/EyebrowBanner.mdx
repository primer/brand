...
description: Use the eyebrow banenr to highlight important information at the top of a page.
---
...
This is the default variant for the eyebrow banner component. It corresponds to the `secondary` variant appearance.
