...
We recommend using either the grid or [stack](/components/Stack) component, depending on how the child items are displayed and how they should work on different screen sizes. If the element has all of its child items displayed inline, the stack component is probably the best option. Otherwise, if you're thinking of columns and rows, use the grid component.
[^2].
