...
title: SectionIntro
status: Experimental
source: https://github.com/primer/brand/tree/main/packages/react/src/SectionIntro/SectionIntro.tsx
storybook: '/brand/storybook/?path=/story/components-SectionIntro--playground'
description: Use SectionIntro to provide a title, optional description and link to a new section in the page.
---
...
Fowrards all props from the [Heading component](/components/Heading), including `as`, `size`, and `weight`.
