...
source: https://github.com/primer/brand/tree/main/src/AnchorNav/AnchorNav.tsx
storybook: '/brand/storybook/?path=/story/components-anchornav--playground'
description: Use AnchorNav for prompt navigation to different sections of a page.
---
...
<Box sx={{position: 'relative', overflowX: 'scroll'}}>
  <AnchorNav>
    <AnchorNav.Link href="#section1">Section one</AnchorNav.Link>
    <AnchorNav.Link href="#section2">Section two</AnchorNav.Link>
    <AnchorNav.Link href="#section3">Section three</AnchorNav.Link>
    <AnchorNav.Link href="#section4">Section four</AnchorNav.Link>
    <AnchorNav.Link href="#section5">Section five</AnchorNav.Link>
