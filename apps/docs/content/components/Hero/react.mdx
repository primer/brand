...
`Hero` can display an optional foreground image. Use `imagePosition` to alternate between various layouts.
...
| name            | type                                                                   | default       | description                                  |
| --------------- | ---------------------------------------------------------------------- | ------------- | -------------------------------------------- |
| `imagePosition` | <PropTableValues values={['inline-end', 'block-end']} addLineBreaks /> | `'block-end'` | Controls positioning of the foreground image |
