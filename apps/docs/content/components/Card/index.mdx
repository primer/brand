...
Cards typically appear in groups of three or four in desktop viewports. For smaller viewports, or when more than four cards, we recommend stacking the cards vertically. You can use the [Grid](/components/Grid) component to achieve this.
...
<div>
  ...
  />
  <Caption>
    Stack cards vertically using multiple rows so that the content has the right
    line lenght and is easy to scan.
  </Caption>
</div>
