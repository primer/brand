...
The shadow can be added using the `hasShadow` prop. This will render the component without the background shadow.
...
```jsx live
<Card href="https://github.com" hasBorder hasShadow>
  <Card.Heading>Code search & code view</Card.Heading>
  <Card.Label>Limited</Card.Label>
  <Card.Description>
    Enables you to rapidly search, navigate, and understand code, right from
...
| `hasShadow` | `boolean` | `false`     | `false`  | A flag used to provide a shadow to the Card |
