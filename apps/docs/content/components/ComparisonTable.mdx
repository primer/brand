...
Featured columns will have the visually-hidden text `featured` appended to their column title. This text is used to identify the featured column to screen reader users and can be customized using the `featuredColumnAccessibleLabel` prop.
...
| `featuredColumnAccessibleLabel` | `string`                                                                                | `featured`  | `false`  | A visually-hidden label which is appended to the end of the column title. Used to identify the featured column to screen reader users.                    |
