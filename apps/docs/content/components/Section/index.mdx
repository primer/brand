...
<ThemeProvider colorMode="dark">
  ...
  >
    <SectionIntro align="center">
      <SectionIntro.Heading size="3" size="3">
        Multiple background images
      </SectionIntro.Heading>
      <SectionIntro.Description>
        This section uses multiple layered background images.
      </SectionIntro.Description>
    </SectionIntro>
  </Section>
...
| `backgroundColor`         | <PropTableValues values={[...SectionBackgroundColors]} commaSeparated  /> \| `string` |            | `false`  | Add a background color. Use a predefined color, a CSS custom property, or a custom color value.                                                               |
