  ...
  <RiverBreakout.Content
    trailingComponent={() => (
      <Timeline>
        ...
        <Timeline.Item>
          <DuotoneText>
            <DuotoneText.Emphasis>GitHub Copilot</DuotoneText.Emphasis> is your
            AI pair programmer that empowers you to complete tasks.
          </DuotoneText>
        </Timeline.Item>
      </Timeline>
    )}
    ...
    <Text>
      <DuotoneText>
        <DuotoneText.Emphasis>
          This first sentence is a river breakout headline.
        </DuotoneText.Emphasis>{' '}
        And this is where the body copy starts. Remember to keep these nice and
        succinct.
      </DuotoneText>
    </Text>
    <Link href="#">Call to action</Link>
