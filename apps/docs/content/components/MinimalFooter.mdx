...
| `socialLinks`        | `['twitter', 'github', 'linkedin', 'youtube', 'facebook', 'twitch', 'tiktok']` \| `false`      | `['twitter', 'github', 'linkedin', 'youtube', 'facebook', 'twitch', 'tiktok', 'instagram']` | Array of valid strings or `false` to hide all links    |
