...
Sub menus appear as a dropdown by default.
...
### Optional anchor-based sub menu
...
| `variant`  | <PropTableValues values={[...SubNavSubMenuVariants]} addLineBreaks /> | `'default'` | `false`  | Alternative presentation for sub menus |
