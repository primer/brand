...
Use CTA banner to draw attention around the main user actions. The CTA banner should be used sparingly, and is typically placed at the bottom of the page to close the user journey,
...
<DoDontContainer>
  <Do>
    <img src="" />
    <Caption>
      Use the CTA banner on the bottom of the page to close the user journey.
    </Caption>
  </Do>
  <Dont>
    <img src="" />
    <Caption>
      Don't use the CTA early on the user journey, use a hero component instead.
    </Caption>
  </Dont>
</DoDontContainer>
...
<DoDontContainer>
  <Do>
    <img src="" />
    <Caption>
      Remove the shadow to diminish the sense of depth and separation from the
      background or to allow the content to blend with the background of the
      page.
    </Caption>
  </Do>
  <Dont>
    <img src="" />
    <Caption>
      Don't use the shadow if you want the content to blend with the background
      and the sections that sorround the CTA banner.
    </Caption>
  </Dont>
</DoDontContainer>
