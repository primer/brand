...
Use a `<span>` element within the timeline items to apply a duotone style and emphasize part of the text.
...
<Timeline>
  ...
  <Timeline.Item>
    <span>GitHub Copilot</span> is your AI pair programmer that empowers you to
