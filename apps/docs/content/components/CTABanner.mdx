...
description: Use CTABanner to draw attention to or create urgency around a user action.
---

```js
import {CTABanner, ButtonGroup, Button, Label} from '@primer/react-brand'
```
...
| `as`        | `h1`, `h2`, `h3`, `h4`, `h5` | `h3`      | `false`  | Content size to be displayed inside the column cell.                  |
| `size`      | `h1`, `h2`, `h3`, `h4`, `h5` | `h3`      | `false`  | True symantic element to be use as the text wrapper.                  |
