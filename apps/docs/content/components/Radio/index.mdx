...
### Grouping
To group related radio components together in a list, use the [Stack](/components/FormControl) and [FormControl](/components/FormControl) components. When rendering a group of radio components, make sure to consider all potential option. Remember to include "None" or "Other" options when necessary. 
