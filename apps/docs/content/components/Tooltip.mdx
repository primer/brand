...
| ------------ | ----------------------------------------------------------------- | --------------- | -------- | --------------------------------------- |
| `direction`  | <PropTableValues values={['n', 'e', 's', 'w']} />                 | `'s'`           | `false`  | The text to be displayed in the tooltip |
| `text`       | `string`                                                          | `undefined`     | `true`   | Determines whether the ActionMenu is open by default |
