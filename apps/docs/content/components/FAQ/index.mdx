...
When using long lists of questions and answers, consider using the FAQ group to group the items into categories and make it easier for the user to scan the list.
...
<DoDontContainer stacked>
  <Do>
    <img
      ...
      alt=""
    />
    <Caption>Use the FAQ group to group related questions and answers.</Caption>
  </Do>
  <Dont>
    <img
