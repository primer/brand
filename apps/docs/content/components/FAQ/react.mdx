...
import {HeadingTags, AccordionToggleColors} from '@primer/react-brand'
...
1. Override the global `--brand-color-accent-primary` CSS variable.
...
| `toggleColor` | <PropTableValues values={AccordionToggleColors} addLineBreaks /> |            | Sets the accordion toggle color          |
