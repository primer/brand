---
title: Section intro
description: Use section intro to provide a title, optional description and link to a new section in the page.
---
...
Use the section intro to introduce a new section element in the page. Section intros uses full-width of the screen and can be used in conjunction with other components that expands the content introduced. For example, the [card](/components/Card) or the [pillar](/components/Pillar) components.
...
<DoDontContainer stacked>
  ...
  <Dont>
    ...
    <Caption>
      Don't use center alignment if the section intro is pareid an image or
      visual asset placed on the left.
    </Caption>
  </Dont>
</DoDontContainer>
