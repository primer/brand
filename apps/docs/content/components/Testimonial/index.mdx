...
![An image displaying a testimonial anatomy.](https://github.com/primer/brand/assets/912236/d9854082-76b6-4c8a-8606-4ce67e2faba0)

- Quote: The quote from the customer.
- Name: The name of the customer.
- Position: The position or role of the customer.
- Avatar: Optional avatar of the customer.
...
Testimonials should be short and concise. Avoid using long or short quotes that can be hard to read and understand or that don't provide enough context.
...
Avatars are optional and can be used to provide more context about the customer. When using an avatar, use an image of the customer to make the testimonial more personal and provide more credibility. If an image is not available, use a logo or similar visual that represents the customer company or organization.

<DoDontContainer>
  <Do>
    <img src="https://github.com/primer/brand/assets/912236/8968b579-1ff6-490e-a5a2-2abd2da588e5" />
    <Caption>Use a real life image of the customer or user.</Caption>
  </Do>
  <Dont>
...
Testimonials can be used individually or in a group. When using a group of testimonials, use the same size and alignment for all of them. When including an avatar, use it in all of them and keep the same style and size. E,g, if using the company logo, use it in all of them. We recommend using a maximum of 4 testimonials per group to avoid visual noise and to keep the quotes relevant.
...
<DoDontContainer stacked>
  ...
  <Dont>
    ...
    <Caption>
      Don't use different sizes, alignments or avatars for groups of
      testimonials.
    </Caption>
  </Dont>
</DoDontContainer>

Use a single testimonial to highlight a specific feature or benefit of the product. Avoid using multiple testimonials to showcase the same feature or benefit.
...
<DoDontContainer stacked>
  ...
  <Dont>
    ...
    <Caption>
      ...
      short. Stack them vertically in 2 columns instead.
    </Caption>
  </Dont>
</DoDontContainer>
