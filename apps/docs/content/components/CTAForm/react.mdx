...
For simplicity, examples on this page include only basic browser-based validation.

When using the CTAForm component in production, you should implement your own validation logic and use the [FormControl validation component](/forms/FormControl/#validation) to display validation messages in line with the [Primer validation guidelines](https://primer.style/product/ui-patterns/forms/#validation).
