...
The Heading scale ranges from 1 to 6 and maps to the HTML heading elements h1 to h6 respectively. The size is determined by the type of HTML element specified, although you can override this when the scenario calls for it. E.g. use a `h4` heading size on a `<h3>` to highlight an article that might be relevant to the user.
...
<DoDontContainer>
  <Do>
    <img src="https://github.com/primer/brand/assets/912236/1fe099cf-a6ea-4e1f-9f6b-8ee7aebefd06" />
    <Caption>
  ...
  <Dont>
    <img src="https://github.com/primer/brand/assets/912236/2b74dd50-fab8-4a6c-8661-71ecfa94de9c" />
    <Caption>
