...
import {PricingOptions, HeadingTags} from '@primer/react-brand'
...
| `appearance` | <PropTableValues values={[`solid`, `gradient` ]} addLineBreaks /> | `"solid"` | `false`  | Sets the container's' appearance    |
| `children`   | `PricingOptions.Item`                                             |           |  `true`  | The items to be displayed           |
| `variant`    | <PropTableValues values={[`default`, `cards` ]} addLineBreaks />  |           | `false`  | Sets the layout variant             |
...
| Name       | Type                                                   |   Default   | required | Description                                       |
| :--------- | :----------------------------------------------------- | :---------: | :------: | :------------------------------------------------ |
| `as`       | <PropTableValues values={HeadingTags} addLineBreaks /> |    `h3`     | `false`  | Applies the underlying HTML heading level element |
...
| `accordionAs` | <PropTableValues values={HeadingTags} addLineBreaks />                                         |    `h4`     | `false`  | Applies the underlying HTML heading level element                                                           |
