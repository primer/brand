...
This is the one-item layout for the pricing options component
...
This is the three-item layout for the pricing options component.
...
<Note>
  ...
  documentation. Please refer to our [Storybook
  examples](https://primer.style/brand/storybook/?path=/story/components-pricingoptions-features--three-items)
