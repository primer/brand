...
| `horizontalAlign` | `"start"`, `"center"`, `"end"`, `ResponsiveAlign`                                                                                                                     | `"start"`  | `false`  | The horozontal alignment of children within the `Bento.Item` |
| `verticalAlign`   | `"start"`, `"center"`, `"end"`, `ResponsiveAlign`                                                                                                                     | `"start"`  | `false`  | The vertical alignment of children within the `Bento.Item`   |
| `fixedBottomLink` | `boolean`                                                                                                                                                             |  `false`   | `false`  | The vertical alignment of children within the `Bento.Item`   |
