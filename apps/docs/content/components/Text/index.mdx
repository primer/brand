...
The text component provides two variant options: `default` and `muted`. The `muted` variant is used to de-emphasize text and is often used for secondary text or as descriptive text when paired with a title.
