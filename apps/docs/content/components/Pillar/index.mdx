...
The Pillar and Card components might lead to ambiguity when deciding which one to use, as both could be used to provide pieces of related and condensed information. Some of the differences between them are:

#### Interaction

Cards should be used as navigational items to lead to the extend of the information, the link is always required. Pillars could be used for just plain, non-navigational content or include an optional link and lead to extra information.
