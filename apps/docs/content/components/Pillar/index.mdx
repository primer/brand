...
Pillars are used mainly for plain content and might include an option link for extended information. On the other hands, Cards are primarily navigational elements.
