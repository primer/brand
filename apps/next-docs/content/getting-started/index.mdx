...
<Note>
  Building with an AI agent? The [Primer Brand MCP server](../introduction/mcp.mdx) helps tools like GitHub Copilot use
  Primer Brand's components, tokens and guidance correctly.
</Note>
