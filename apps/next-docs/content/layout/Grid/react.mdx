...
| `columnGap`     | <PropTableValues values={['default', 'none']} addLineBreaks />        | `'default'` | `false`  | Defines the gap between columns.          |
...
| `rowGap`        | <PropTableValues values={['default', 'none']} addLineBreaks />        | `'default'` | `false`  | Defines the gap between rows.             |
