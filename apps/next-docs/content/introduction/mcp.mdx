...
| `primer_brand_page_design` | Page-design conventions (header/footer, hero media, gridline aesthetic, card grids) and the current-brand reference templates to start from. |
