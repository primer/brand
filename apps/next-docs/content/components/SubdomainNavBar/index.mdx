...
The `full` variant displays the GitHub name alongside the site title and an expanded search field on desktop.

Please check with the Brand Experience before using this variant.

```jsx live
<div style={{width: '100%'}}>
  <SubdomainNavBar title="Site title" variant="full" fixed={false} fullWidth>
...
| `variant`               | `'default' \| 'full'`                | `'default'`          | Sets the navigation layout                                              |
