...
To provide static content designed specifically for the search dialog, pass it as
children of `SubdomainNavBar.Search`. Custom content is rendered below the search
input and above any built-in `searchResults`.
...
>
  <div>
    ...
    <p>How do I connect to GitHub with my SSH?</p>
    <p>How do I sign commits?</p>
    <strong>Docs results</strong>
...
| `children`         | `React.ReactNode`                                |                  | Optional custom content rendered below the input and above built-in results |
