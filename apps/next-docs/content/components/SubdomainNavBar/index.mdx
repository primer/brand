...
The `project` variant provides a simplified navigation layout, with links on a separate row on desktop.

```jsx live
<div style={{width: '100%'}}>
  <SubdomainNavBar title="Project title" variant="project" fixed={false} fullWidth>
...
| `variant`               | `'default' \| 'project'`             | `'default'`          | Sets the navigation layout                                              |
