...
import {PillarAsProp, PillarIconSizeProp} from './react'
...
| `hasBorder` | `boolean`         | `false` | `false`  | Enables an optional border around the pillar content.            |
...
| `size`          | <PillarIconSizeProp /> | `32`    | `false`  | The size of the icon                                                                                                              |
...
Supports the [Icon component](/components/Icon) props, excluding `color`.
