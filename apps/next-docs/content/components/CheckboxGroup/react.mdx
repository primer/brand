...
import {ValidationStatusProp} from './react.tsx'
...
| `validationStatus` | <ValidationStatusProp /> |         | Ussed to inform ARIA attributes. Individual checkboxes do not have validation styles.                                                         |
