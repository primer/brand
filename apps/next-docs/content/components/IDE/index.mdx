...
> See Storybook for examples of `IDE` using `highlight.js` syntax highlighter. [See syntax highlighter examples](https://primer.style/brand/storybook/?path=/story/components-ide--default)
...
> See Storybook for a comprehensive example of the Chat feature, inclusive of syntax highlighting. [See Chat example in Storybook](https://primer.style/brand/storybook/?path=/story/components-ide-features--chat-only)
