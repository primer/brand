...
a11yReviewed: true
thumbnail: '/images/thumbnails/bento-thumbnail.png'
thumbnail_darkMode: '/images/thumbnails/bento-thumbnail-dark.png'
---

import {
  BentoColumnIndexProps,
  BentoRowIndexProps,
  BentoFlowProps,
  BentoColorModeProps,
  BentoOrderProps,
...
| `columnStart`        | <BentoColumnIndexProps /> |           | `false`  | The column number in which this content should start                                                                            |
| `columnSpan`         | <BentoColumnIndexProps /> |           | `false`  | The number of columns this content should span                                                                                  |
| `rowStart`           | <BentoRowIndexProps />    |           | `false`  | The row number in which this content should start                                                                               |
| `rowSpan`            | <BentoRowIndexProps />    |           | `false`  | The number of rows this content should span                                                                                     |
| `flow`               | <BentoFlowProps />        |           | `false`  | The flow of the `Bento.Content` and `Bento.Visual` within the `Bento.Item`                                                      |
| `colorMode`          | <BentoColorModeProps />   | `"light"` | `false`  | The color mode specified for this `Bento.Item`                                                                                  |
...
| `order`              | <BentoOrderProps />       | `default` | `false`  | Determines the visual order for the `Bento.Item`. This changes the semantic ordering of elements for accessibility.             |
...
| `padding`         | <BentoPaddingProps /> | `"normal"` | `false`  | Sets a custom class on the root element                         |
| `horizontalAlign` | <BentoAlignProps />   | `"start"`  | `false`  | The horizontal alignment of children within the `Bento.Content` |
| `verticalAlign`   | <BentoAlignProps />   | `"start"`  | `false`  | The vertical alignment of children within the `Bento.Content`.  |
...
| `padding`   | <BentoPaddingProps /> |             | `false`  | Sets a custom class on the root element                                                                  |
