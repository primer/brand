...
| `appearance` | <PricingOptionsAppearanceProp /> | `"solid"` | `false`  | Sets the container's' appearance    |
| `children`   | `PricingOptions.Item`            |           |  `true`  | Applies the underlying HTML element |
| `variant`    | <PricingOptionsVariantProp />    |           | `false`  | Sets the layout variant             |
