...
thumbnail_darkMode: '/images/thumbnails/statistic-thumbnail-dark.png'
---

import {StatisticSizeProp, StatisticPaddingProp, StatisticDescriptionVariantProp} from './react'
...
| `size`      | <StatisticSizeProp />                        | `'large'` | The size of the Statistic                             |
| `padding`   | <StatisticPaddingProp />                     | `'none'`  | Adding padding to all internal sides of the component |
