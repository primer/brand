...
import {
  ...
  RiverImageTextRatio,
  RiverVariantProp,
  RiverVisualPositionProp,
  RiverVisualPaddingProp,
} from './react'
...
[`EyebrowText`](/brand/storybook/?path=/story/components-eyebrowtext--default), [`Text`](/typography/Text),
[`Heading`](/typography/Heading), and
[`Link`](/brand/storybook/?path=/story/components-link--default) are the supported `children`. They can be composed in
...
| Name        | Type                                                                                                                                                                                                           | Default | Description                                      |
| :---------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----: | :----------------------------------------------- |
| `children`  | [`EyebrowText`](/brand/storybook/?path=/story/components-eyebrowtext--default), [`Text`](/typography/Text), [`Heading`](/typography/Heading), [`Link`](/brand/storybook/?path=/story/components-link--default) |         | Content that corresponds to the adjacent visual. |
| `className` | `string`                                                                                                                                                                                                       |         | Sets a custom class on the root element          |
| `id`        | `string`                                                                                                                                                                                                       |         | Sets a custom id                                 |
| `ref`       | `React.RefObject`                                                                                                                                                                                              |         | Forward a Ref to the underlying DOM node         |
