...
import {RiverAlignPropDefault, RiverImageTextRatioDefault} from './react'
...
| :--------------- | :----------------------------- | :----------------------------: | :---------------------------------------------------------------------------------------------------------- |
| `align`          | `'start'`, `'end'`, `'center'` |   <RiverAlignPropDefault />    | Alignment of text content relative to the Visual position                                                   |
| `imageTextRatio` | `'50:50'`, `'60:40'`           | <RiverImageTextRatioDefault /> | The aspect ratio applied to the image in relation to the adjacent text. Affects overall layout proportions. |
