...
| ------------------------- | -------------------------------------- | ----------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `variant`                 | `'default'` \| `'gridline'`            | `'default'` | `false`  | Sets the visual variant. The `gridline` variant adds horizontal gridlines and responsive container-edge borders. `rounded` is not supported with `gridline`.  |
