...
### Customize gridline inline padding

Override `--brand-Section-variant-gridline-paddingInline` to customize the inline padding of a gridline section.

```css
.customSection {
  --brand-Section-variant-gridline-paddingInline: var(--base-size-32);
}
```
...
| ------------------------- | -------------------------------------- | ----------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `variant`                 | `'default'` \| `'gridline'`            | `'default'` | `false`  | Sets the visual variant. The `gridline` variant adds horizontal gridlines, responsive inline padding, and container-edge borders at wide viewports. `rounded` is not supported with `gridline`. |
...
| `rounded`                 | `boolean`                              | `false`     | `false`  | Adds rounded corners to the top of the section. Ignored when `variant` is `'gridline'`.                                                                                                         |
| `fullWidth`               | `boolean`                              | `false`     | `false`  | Makes the container fill the entire width of the section. With the `gridline` variant, this also removes its inline padding and container-edge borders.                                         |
