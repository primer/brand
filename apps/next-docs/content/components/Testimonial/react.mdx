...
| `variant`        | <TestimonialVariantProp />        | `'minimal'` | Alternative visual appearance. Use `'expressive'` for a two-column layout with the quote on the left and attribution on the right. |
