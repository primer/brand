...
thumbnail: '/images/thumbnails/breadcrumbs-thumbnail.png'
...
<DoDontContainer>
  <Do>
    <img src={doOverflow.src} alt="" />
    <Caption>Use short Breadcrumb item names to ensure they fit within a 320px wide viewport.</Caption>
  </Do>
  <Dont>
    <img src={dontOverflow.src} alt="" />
    <Caption>
...
<img src={variants.src} alt="The two breadcrumbs variants available: default and accent" />
