...
| `align`                   | <CTABannerAlignProp />           | `'start'`   | `false`  | The horizontal positioning of content within the banner component           |
...
| `hasGridLines`            | `boolean`                        | `false`     | `false`  | Enable gridlines. Complimentary to `hasBorder`, and enables that by default |
