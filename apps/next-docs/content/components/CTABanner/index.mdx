...
- Octovisual: Our expressive icon set as an optional visual
...
- Optional description: A short callout that might include an inline link
...
The CTA banner always uses a solid background the canvas/muted color for both light and dark mode. Don't use color backgrounds for the CTA banner
...
The CTA banner is contained by horizontal grid lines that extend the full width of the page and left and right borders.
