...
thumbnail: '/images/thumbnails/section-intro-thumbnail.png'
thumbnail_darkMode: '/images/thumbnails/section-intro-thumbnail-dark.png'
---
...
We recommend using the section intro as a header of an HTML `<section>` element. Sections divide the content of the page into thematic groups and represent standalone elements that are typically related to a specific topic or subject within the document.
