...
When linking to the footnotes via a citation, ensure that the touch target is large enough to be easily clickable.
  ...
  <River>
    ...
    <River.Content>
      ...
      <Text as="p" size="200" weight="light" variant="muted">
        ...
        <Text size="100" weight="light">
          <sup>
            <InlineLink href="#ai" id="ai-ref" style={{display: 'inline-block', minWidth: 'var(--base-size-24)'}}>
              2
            </InlineLink>
          </sup>
        </Text>
