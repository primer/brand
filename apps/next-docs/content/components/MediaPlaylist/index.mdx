...
keywords: ['media', 'playlist', 'tabs', 'video']
show-tabs: false
ready: true
...
| `as`       | `'h2' \| 'h3'` | `'h3'`  | Semantic heading level                                                 |
...
`MediaPlaylist.ItemHeading` extends the [`Heading`](/components/Heading) component.
...
| `fillMedia`            | `boolean`               | `true`  | Applies automatic media sizing   |
| `hasShadow`            | `boolean`               | `false` | Applies a shadow to child media  |
| `rounded`              | `boolean`               | `true`  | Enables rounded corners          |
| `imageBackgroundColor` | `'default' \| 'subtle'` |         | Optional background around media |
