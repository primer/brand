...
storybook: '/react-brand/storybook/?path=/story/components-faq--default'
...
| Name        | Type                                                            |  Default   | Description             |
| :---------- | :-------------------------------------------------------------- | :--------: | :---------------------- |
| `align`     | <PropTableValues values={['start', 'center' ]} addLineBreaks /> | `'center'` | Heading text alignement |
...
| :---------- | :------- | :-----: | :------------------------------------------------------------------- |
| `className` | `string` |         | Sets a custom class on the root element                              |
| `children`  | `Text`   |         | Answer text. `Text` children are automatically formatted and styled. |
