...
This is a Technical Preview for `FormControl`.

`FormControl` will be generally available in the next `minor` release.
...
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------ | :-----: | :---------------------------------------------------------------- |
| `children`         | <PropTableValues values={['FormControl.Label','TextInput', 'FormControl.Validation', 'React.ReactElement', ]} addLineBreaks />, |         | Valid child nodes                                                 |
