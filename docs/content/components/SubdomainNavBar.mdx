...
Please refer to our [Storybook examples](/brand/storybook/?path=/story/components-subdomainnavbar--default) to see the component in a full-screen browser as originally intended.
