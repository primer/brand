...
source: https://github.com/primer/brand/tree/main/src/TextInput/TextInput.tsx
...
This is a Technical Preview for `TextInput`.

`TextInput` will be generally available in the next `minor` release.
