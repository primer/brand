...
| Name            | Type           | Default | Description                                                                                                                           |
| :-------------- | :------------- | :-----: | :------------------------------------------------------------------------------------------------------------------------------------ |
| `autoSizeMedia` | `boolean`      |  true   | Automatically styles images and video to fill the width of the parent. Disable this setting if you have bespoke styling requirements. |
