...
type AzureLogoProps = React.SVGProps<SVGSVGElement>

export const AzureLogo = (props: AzureLogoProps) => (
  <svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-label="Azure icon" {...props}>
    <defs>
      <linearGradient
        id="azureGradientA"
        x1="-1032.17"
