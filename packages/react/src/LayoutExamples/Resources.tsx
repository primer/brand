...
export function ResourcesHubExample(props: ResourcesHubExampleProps) {
  const inputRef = useRef()

  // eslint-disable-next-line i18n-text/no-en
  const mockHandler = () => alert('You clicked me!')
  ...
  return (
    <>
      <SubdomainNavBar title="Resources" titleHref="https://resources.github.com/devops/tools/compare/" {...props}>
        ...
        <SubdomainNavBar.Link href="#">Types</SubdomainNavBar.Link>
        <SubdomainNavBar.Search ref={inputRef} onChange={mockHandler} onSubmit={mockHandler} />
        <SubdomainNavBar.PrimaryAction href="#">Free trial</SubdomainNavBar.PrimaryAction>
      ...
      <div style={{marginTop: 100}}>
        <AnchorNav enableDefaultBgColor>
          ...
          <AnchorNav.Link href="#comparegitlab">GitHub vs. GitLab</AnchorNav.Link>
          <AnchorNav.Link href="#comparebitbucket">GitHub vs. Bitbucket</AnchorNav.Link>
          ...
          <div id="why-github">
            <div style={{maxWidth: '900px', margin: '0 auto'}}>
              <Stack padding="spacious" direction="vertical">
                <Stack direction="vertical" justifyContent="center" style={{textAlign: 'center'}}>
                  <Heading as="h2" size="3">
                    More than 90% of the Fortune 100 use GitHub Enterprise
                  </Heading>
                  <Text as="p">
                    DevOps is just the beginning. From <InlineLink href="#">McKesson</InlineLink> to{' '}
                    <InlineLink href="#">Meta</InlineLink> and Spotify to SAP, many of the world&apos;s biggest and most
                    innovative companies are built on GitHub—the leading developer platform compared to alternative
                    solutions.
                  </Text>
                </Stack>
                <LogoSuite hasDivider={false}>
                  <LogoSuite.Heading visuallyHidden>GitHub users</LogoSuite.Heading>
                  <LogoSuite.Logobar>
                    <svg
                      role="img"
                      focusable="false"
            ...
            <div style={{maxWidth: '83%', margin: '0 auto'}}>
              <River align="start">
                <River.Content>
                  <Heading as="h4">Build on the most loved developer platform</Heading>
                  <Text>
                    Build what&apos;s next with the all-in-one solution that&apos;s beloved by developers. Go from
                    ideation to planning, project management, security, automation and delivery with extensive native
                    capabilities and a rich integration ecosystem.
                  </Text>
                </River.Content>
                <River.Visual>
                  <img
                    src="https://resources.github.com/assets/img/devops/compete/why-teams-choose-image-2.png"
                    alt="GitHub Actions check"
                  />
                </River.Visual>
              </River>
            </div>
            ...
            >
              <img
                src="https://via.placeholder.com/400x200/f5f5f5/f5f5f5.png"
          ...
          <ThemeProvider colorMode="dark" style={{backgroundColor: 'var(--brand-color-canvas-default'}}>
            <div style={{maxWidth: '1280px', margin: '50px auto'}}>
              <Stack padding="spacious">
                <River align="end">
                  <River.Visual>
                    <img src={ciCD} alt="composition of multiple images about ci and cd" />
                  </River.Visual>
                  <River.Content>
                    <Heading>Scale faster with powerful CI/CD</Heading>
                    <Text>
                      Build your DevOps practice with native CI/CD that responds to any webhook. Bring your preferred
                      tools seamlessly into your workflow with a rich ecosystem of integrations in the GitHub
                      Marketplace—or build your own integrations fast with GitHub Actions.
                    </Text>
                    <Link href="#">Explore GitHub Marketplace</Link>
                  </River.Content>
                </River>
              </Stack>
            </div>
          ...
          >
            <Testimonial>
              <Testimonial.Quote>
                ...
                first line of code you&apos;re writing.
              </Testimonial.Quote>
              <Testimonial.Name>David Ross</Testimonial.Name>
            </Testimonial>
            <Testimonial>
              <Testimonial.Quote>
                GitHub keeps us up to speed with the industry&apos;s best tools. We want new hires to know GitHub is in
                our toolchain—it makes them excited to join us.
              </Testimonial.Quote>
              <Testimonial.Name position="Head of Emerging Tech">American Airlines</Testimonial.Name>
            </Testimonial>
            <Testimonial>
              <Testimonial.Quote>
                It&apos;s like night and day. It&apos;s the collaboration, it&apos;s the sharing, it&apos;s the
                community. It&apos;s all because of GitHub.
              </Testimonial.Quote>
              <Testimonial.Name position="Director of Build Platform">Autodesk</Testimonial.Name>
            </Testimonial>
          </Stack>
        </div>
        <div id="comparegithub" style={{maxWidth: '900px', margin: '0 auto'}}>
          <Stack direction="vertical" justifyContent="center" alignItems="center" style={{textAlign: 'center'}}>
            <Heading as="h2" size="3">
        ...
        <Stack
          ...
          style={{maxWidth: 1280, margin: '100px auto'}}
        >
          <ComparisonTable featuredColumn={1} heading="GitHub vs GitLab">
            <ComparisonTable.Row>
              <ComparisonTable.Cell>Use case</ComparisonTable.Cell>
              <ComparisonTable.Cell>GitHub</ComparisonTable.Cell>
              <ComparisonTable.Cell>GitLab</ComparisonTable.Cell>
            </ComparisonTable.Row>
            <ComparisonTable.Row>
              <ComparisonTable.Cell>Automation & CI/CD</ComparisonTable.Cell>
              <ComparisonTable.Cell>
        ...
        <Stack
          ...
          style={{maxWidth: 1280, margin: '100px auto'}}
        >
          <ComparisonTable featuredColumn={1} heading="GitHub vs Bitbucket">
            <ComparisonTable.Row>
              <ComparisonTable.Cell>Use case</ComparisonTable.Cell>
              <ComparisonTable.Cell>GitHub</ComparisonTable.Cell>
              <ComparisonTable.Cell>Bitbucket</ComparisonTable.Cell>
            </ComparisonTable.Row>
            <ComparisonTable.Row>
              <ComparisonTable.Cell>Automation & CI/CD</ComparisonTable.Cell>
              <ComparisonTable.Cell>
