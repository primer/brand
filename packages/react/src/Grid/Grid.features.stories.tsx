...
export const ColumnSpacing = args => {
  return (
    <Stack direction="vertical">
      <div>
        ...
        <Grid {...args} gap="condensed" style={{backgroundColor: 'var(--base-color-scale-red-1)'}}>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
      ...
      <div>
        ...
        <Grid {...args} gap="normal" style={{backgroundColor: 'var(--base-color-scale-red-1)'}}>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
      ...
      <div>
        ...
        <Grid {...args} gap="spacious" style={{backgroundColor: 'var(--base-color-scale-red-1)'}}>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
          <Grid.Column span={1}></Grid.Column>
