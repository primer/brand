...
import backgroundImageDark from '@primer/brand-templates-and-media/fixtures/images/background-stars.png'
import backgroundImageLight from '@primer/brand-templates-and-media/recipes/FeaturePreviewLPs/fixtures/images/other/light-bg.png'
