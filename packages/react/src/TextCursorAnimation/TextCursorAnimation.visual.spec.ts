...
test.describe('Visual Comparison: TextCursorAnimation', () => {
  ...
  test('TextCursorAnimation / With initial text transition', async ({page}) => {
    await page.goto(
      'http://localhost:6006/iframe.html?args=&id=components-textcursoranimation-features--with-initial-text&viewMode=story',
      {waitUntil: 'networkidle'},
    )
    await page.locator('body.sb-show-main').waitFor({state: 'visible'})
