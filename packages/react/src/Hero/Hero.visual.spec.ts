...
test.describe('Visual Comparison: Hero', () => {
  ...
  test('Hero / With a HTML video (bottom)', async ({page}) => {
    await page.goto(
      'http://localhost:6006/iframe.html?args=&id=components-hero-features--with-native-block-end-default&viewMode=story',
    )
  ...
  test('Hero / With a Youtube video (bottom)', async ({page}) => {
    await page.goto(
      'http://localhost:6006/iframe.html?args=&id=components-hero-features--with-youtube-video-block-end-default&viewMode=story',
    )
  ...
  test('Hero / With a Youtube video (right)', async ({page}) => {
    await page.goto(
      'http://localhost:6006/iframe.html?args=&id=components-hero-features--with-youtube-video-inline-end&viewMode=story',
    )
