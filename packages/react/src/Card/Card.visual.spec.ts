...
test.describe('Visual Comparison: Card', () => {
  ...
  test('Card / Image And Label With Fragment', async ({page}) => {
    await page.goto(
      'http://localhost:6006/iframe.html?args=&id=components-card-features--image-and-label-with-fragment&viewMode=story',
    )
