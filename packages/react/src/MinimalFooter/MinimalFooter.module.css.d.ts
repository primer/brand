declare const styles: {
  ...
  readonly "Footer__backToTop": string;
  ...
  readonly "Footer__copyright-and-links": string;
  ...
  readonly "Footer__terms": string;
  readonly "Footer__terms-item": string;
  readonly "Footer__top": string;
