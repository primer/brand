...
import xcodeLogo from '../fixtures/images/logos/xcode.png'
import azureLogo from '../fixtures/images/logos/azure.png'
...
export const tileItems: Array<{name: string; href?: string; icon: React.ReactNode}> = [
  ...
  },
  {
    ...
    icon: <img src={xcodeLogo} alt="Xcode" width="44" height="44" />,
  },
  {
    name: 'JetBrains',
    href: 'https://www.jetbrains.com',
    icon: <JetBrainsLogo width="44" height="44" />,
  },
  {
    name: 'Neovim',
    href: 'https://neovim.io',
    icon: <NeoVimLogo width="44" height="44" />,
  },
  {
    name: 'Azure',
    href: 'https://azure.microsoft.com',
    icon: <img src={azureLogo} alt="Azure" width="44" height="44" />,
  },
  {
    name: 'GitHub',
    href: 'https://github.com',
