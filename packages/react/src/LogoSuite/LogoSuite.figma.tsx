...
figma.connect(
  LogoSuite,
  'https://www.figma.com/design/BJ95AjraesmRCWsKA013GS/Primer-Brand?node-id=14825-1968&t=R95Qkrf0BUjsetcA-11',
  {
    props: {
      headingText: figma.boolean('heading?', {
      ...
      logobarProps: figma.nestedProps('Logobar', {
