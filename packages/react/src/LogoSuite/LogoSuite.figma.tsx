...
figma.connect(LogoSuite, 'https://www.figma.com/design/BJ95AjraesmRCWsKA013GS/Primer-Brand?node-id=8553-10133&m=dev', {
  props: {
    description: figma.textContent('Description'),
    heading: figma.textContent('Text'),
  ...
  example: ({heading, description, align}) => (
...
figma.connect(LogoSuite, 'https://www.figma.com/design/BJ95AjraesmRCWsKA013GS/Primer-Brand?node-id=8553-10133&m=dev', {
  ...
  variant: {'heading?': true, 'description?': false},
  example: ({heading, align}) => (
    <LogoSuite align={align}>
      <LogoSuite.Heading>{heading}</LogoSuite.Heading>
      <LogoSuite.Logobar>
        <svg role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 16" width="45" height="16">
...
figma.connect(LogoSuite, 'https://www.figma.com/design/BJ95AjraesmRCWsKA013GS/Primer-Brand?node-id=8553-10133&m=dev', {
  ...
  variant: {'heading?': false, 'description?': false},
  example: ({align}) => (
    <LogoSuite align={align}>
      <LogoSuite.Logobar>
        <svg role="img" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 16" width="45" height="16">
...
figma.connect(LogoSuite, 'https://www.figma.com/design/BJ95AjraesmRCWsKA013GS/Primer-Brand?node-id=8353-38790&m=dev', {
  props: {
    description: figma.textContent('Description'),
    heading: figma.textContent('Text'),
    align: figma.enum('align', {
