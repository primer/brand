...
export const Sizes = () => (
  <Stack direction="horizontal" alignItems="center" justifyContent="center" gap="spacious" style={{height: '100vh'}}>
    ...
    <Avatar size={48} src="https://i.pravatar.cc/128?u=167" alt="A random avatar picture" />
    <Avatar size={64} src="https://i.pravatar.cc/128?u=51" alt="A random avatar picture" />
    <Avatar size={80} src="https://i.pravatar.cc/128?u=109" alt="A random avatar picture" />
  </Stack>
)

export const Shapes = () => (
  <Stack direction="horizontal" alignItems="center" justifyContent="center" gap="spacious" style={{height: '100vh'}}>
    <Avatar shape="circle" size={48} src="https://i.pravatar.cc/128?u=51" alt="A random avatar picture" />
    <Avatar shape="square" size={48} src="https://i.pravatar.cc/128?u=51" alt="A random avatar picture" />
  </Stack>
)
