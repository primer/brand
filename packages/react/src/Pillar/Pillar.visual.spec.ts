...
test.describe('Visual Comparison: Pillar', () => {
  ...
  test('Pillar / With InlineCode', async ({page}) => {
    await page.goto(
      'http://localhost:6006/iframe.html?args=&id=components-pillar-features--with-inline-code&viewMode=story',
      {waitUntil: 'networkidle'},
    )
    await page.locator('body.sb-show-main').waitFor({state: 'visible'})
  ...
  test('Pillar / Inline Code Stacked', async ({page}) => {
    await page.goto(
      'http://localhost:6006/iframe.html?args=&id=components-pillar-features--inline-code-stacked&viewMode=story',
      {waitUntil: 'networkidle'},
    )
    await page.locator('body.sb-show-main').waitFor({state: 'visible'})
  ...
  test('Pillar / Full Width', async ({page}) => {
    await page.goto(
      'http://localhost:6006/iframe.html?args=&id=components-pillar-features--full-width&viewMode=story',
      {waitUntil: 'networkidle'},
    )
    await page.locator('body.sb-show-main').waitFor({state: 'visible'})
