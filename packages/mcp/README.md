...
| `primer_brand_page_design` | Page-design conventions (header/footer, hero media, gridline aesthetic, card grids, Token-first metadata) and the current-brand reference templates to start from. |
